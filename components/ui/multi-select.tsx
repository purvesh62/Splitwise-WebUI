...
>(({className, ...props}, ref) => {
	...
	return (
		<CommandPrimitive.Input
			...
			className={cn(
				"px-2 text-base md:text-sm bg-transparent outline-none placeholder:text-muted-foreground",
				className,
...
>(({className, value, children, ...props}, ref) => {
	...
	return (
		<CommandItem
			...
			className={cn(
				"rounded-md cursor-pointer px-1 py-1 transition-colors flex justify-between ",
				className,
